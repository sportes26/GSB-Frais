...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 02 juin 2019 à 21:10
...
('g43', 'Johnny', 'Depp', 'jdepp', 'shgcshd', '8 rue des Charmes', '46000', 'Cahors', '2005-12-21'),
('g52', 'Monroe', 'Marilyn', 'mmonroe', 'ydfyghfhy', '22 rue des Ternes', '46123', 'Gramat', '2000-05-01'),
('h24', 'Jolie', 'Angelina', 'ajolie', 'ozkndh', '12 allée des Anges', '93230', 'Romainville', '2003-08-11'),
('h3', 'Jackson', 'Michael', 'mjackson', 'hjdsfshjds', '1 Avenue gambetta', '46000', 'Cahors', '1998-05-11'),
('i26', 'Obama', 'Barack', 'bobama', 'izbnfeyc', '16 avenue des Cèdres', '23200', 'Guéret', '2001-02-05');
...
('a131', '201905', 0, '0.00', '2019-06-02', 'CL'),
('a131', '201906', 0, '0.00', '2019-06-02', 'CR'),
('a17', '201903', 0, '0.00', '2019-03-05', 'CR'),
('a55', '201903', 0, '0.00', '2019-04-17', 'CL'),
('a55', '201904', 0, '0.00', '2019-04-17', 'CR'),
('f21', '201903', 0, '0.00', '2019-03-06', 'CR');
...
CREATE TABLE IF NOT EXISTS `justificatif` (
  ...
  `dossier` int(20) NOT NULL,
  `bien` varchar(30) NOT NULL,
  `immobilier` varchar(30) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `justificatif` (`id`, `client`, `dossier`, `bien`, `immobilier`) VALUES
(1, 'jean', 256, 'maison', 'table'),
(2, 'paul', 345, 'voiture', 'appartement'),
(4, 'jack', 768, 'piscine', 'appartement'),
(5, 'maurice', 876, 'maison', 'chaise'),
(7, 'myriam', 26, 'brioche', 'appartement');
